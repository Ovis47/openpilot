...
# Prius（TSS-P）は操舵トルクの上限で横加速度 1.4〜1.5 m/s² しか出せないため、減速を早めに始める
...
# 実車で出せる横加速度に合わせる。2.0 のままだと減速が足りず、操舵が上限に張り付いて曲がりきれない
_A_LAT_REG_MAX = 1.4  # Maximum lateral acceleration
